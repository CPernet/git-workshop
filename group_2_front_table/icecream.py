...
data['temperature [Celsius]'] = pd.to_numeric(datadata['temperature [Celsius]'], errors='coerce')
...
new_data = pd.DataFrame({'temperature [Celsius]': [40]})
predicted_scoops = model.predict(new_data)
